...
if($submit)
{
	if($gameID)
	{
		$delete = "DELETE FROM games WHERE gameID = $gameID";
		$delete2 = "DELETE FROM batting WHERE batting.gameID = $gameID";
		$delete3 = "DELTE FROM pitching WHERE pitching.gameID = $gameID";
